...
def analyze_market(symbol: str, interval: str) -> dict:
    ...
    try:
        ...
        if diff_minutes > 45:
            return {
                'status': 'error',
                'message': 'هذا السوق مغلق حالياً في البورصة العالمية (تفتح البورصة الأمريكية 4:30 م بتوقيت مكة). الأسواق المفتوحة والنشطة الآن هي: أزواج العملات والعملات الرقمية.'
            }
